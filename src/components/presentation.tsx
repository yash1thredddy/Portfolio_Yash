...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Yashwanth (but you can call me Yash) - an E-shaped engineer who's all about building systems that actually scale and make a real impact. From distributed systems handling 5M+ calls/day to ML pipelines to full-stack apps - I go deep in multiple areas and love connecting the dots across the stack 🚀",
    src: '/Profile.png',
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['Distributed Systems', 'Backend', 'AI/ML', 'Full-Stack', 'E-Shaped Engineer'].map(
              (tag) => (
                <span
                  key={tag}
