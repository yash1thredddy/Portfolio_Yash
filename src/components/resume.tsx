...
export function Resume() {
  ...
  const resumeDetails = {
    ...
    description: 'Software Engineer - Distributed Systems & AI',
    fileType: 'PDF',
    lastUpdated: 'January 2025',
    fileSize: '0.2 MB',
    previewImageSrc: '/resume-preview.png', // Using placeholder - update with actual preview image
    downloadUrl: '/Yashwanth_Resume_Exp.pdf',
  };
