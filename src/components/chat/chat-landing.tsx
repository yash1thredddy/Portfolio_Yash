...
import { Award, BriefcaseBusiness, Code, GraduationCap, Mail, MessageSquare } from 'lucide-react';
    ...
    >
      ...
      <motion.div className="mb-8 text-center" variants={itemVariants}>
        <h2 className="mb-3 text-2xl font-semibold">
          I'm Yashwanth's AI Assistant
        </h2>
        <p className="text-muted-foreground mx-auto max-w-md">
          Ask me anything about Yashwanth's experience, projects, and skills!
        </p>
      </motion.div>
