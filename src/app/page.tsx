...
const questions = {
  ...
  Experience: 'Tell me about your work experience and what you have built at ImpacterAI, UIC, and SimplyFI.',
  Projects: 'What are your projects? What are you working on right now?',
  Skills: 'What are your skills? Give me a list of your soft and hard skills.',
  Fun: 'What is the craziest thing you have ever done? What are your hobbies?',
  Contact: 'How can I contact you?',
} as const;

const questionConfig = [
  { key: 'Me', color: '#329696', icon: Laugh },
  { key: 'Experience', color: '#FF6B35', icon: BriefcaseBusiness },
  { key: 'Projects', color: '#3E9858', icon: Layers },
    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pb-10 md:pb-20">
      ...
      <div className="relative z-10 h-52 w-48 overflow-hidden sm:h-72 sm:w-72">
        <Image
          ...
          height={2000}
          priority
          className="translate-y-1 scale-[1.2] object-cover rounded-full"
        />
      </div>
